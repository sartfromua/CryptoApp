...
object CryptoCardRepositoryImpl: CryptoCardsRepository {
    ...
    init {
        addCryptoCard(CryptoCard("BTC", 43000.0, 1230000.0, 42999.9, 44000.0, 3.5))
        addCryptoCard(CryptoCard("ETH", 1900.0, 65000.0, 6400.9, 6500.0, 1.5))
        addCryptoCard(CryptoCard("USDT", 1.03, 37.0, 36.9, 38.0, 0.5))
    }
